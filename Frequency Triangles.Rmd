...
real sharedpars_exposure_lpmf(int Nposincrement,
  ...
  return binomial_lpmf(Nnegincrement|Nprev,fmax(1e-10,fmin(0.99,(Nest[2,2]-Nest[1,2])/Nest[1,1]))) + poisson_log_lpmf(Nposincrement|log(exposure) - log(1e7)+ log(Upois) + log_diff_exp(lognormal_lccdf(tprev|log(60)-2.3*sigmapois-exp(mupois),sigmapois), lognormal_lccdf(t|log(60)-2.3*sigmapois-exp(mupois),sigmapois)));
