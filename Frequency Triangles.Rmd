...
formula_def = bf(N_group_increment | vint(N,modelflag) ~ lambdapos + log(exposure),
   ...
   nlf(lambdapos ~ Upos + logdifffunction(t,mup,sigmap) ) ,# std incremental poisson model for N+ using modified version of lccdf for syntax and numerical accuracy in the tail. 
   ...
   nlf(mun~5-2.3*sigman-exp(muneg+1)),# Constrained mu for >99% development at z=5
