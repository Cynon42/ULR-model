...
```
now that we gotr that working, we move to getting a few samples from tidybayes
...
posterior_predict_binomsharedpars <- function(i, prep, ...) {
  # N_int(t,Upois,Ubin,mupois,sigmapois,mubin,sigmabin)
  prep_extract <<- prep
