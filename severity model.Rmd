...
formula_sev <- bf(ACPC_increment  ~ exp(ult)*exp(log_diff_exp(lognormal_lcdf_mod(DevMth,mudev,sigmsdev),lognormal_lcdf_mod(DevMthprev,mudev,sigmadev)))
                       ,sigma ~ (1+DevMth|ReservingClass)
...
mypriors_sev <- c(
  ...
  prior(normal(0, 1), nlpar = "sigmaedv"),
